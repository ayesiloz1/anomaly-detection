...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--data_dir', type=str, default = 'anomaly-detection', help='path to dataset')
        parser.add_argument('--gpu', type=str, default='0', help='gpu number : e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--save_dir', type=str, default='train_results', help='models are saved here')
        ...
        parser.add_argument('--dataset', type=str, default='bowtie', help='chooses how datasets are loaded.')
        parser.add_argument('--verbose', action='store_true', help='if specified, print more debugging information')
        parser.add_argument('--cropsize', type=int, default=256, help='crop image size')
        parser.add_argument('--object', type=str, default='Bowtie', help='the object for training')
